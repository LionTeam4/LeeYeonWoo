...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields=('id','title', 'school', 'contents', 'created', 'image', 'comments')
...
class InfoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Info
        fields=('id', 'school','region','start_date','end_date','fes_location','lineup','created','image','poster','info_reviews')